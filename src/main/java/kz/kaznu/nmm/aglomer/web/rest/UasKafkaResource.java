...
@RestController
@RequestMapping("/api/uas-kafka")
public class UasKafkaResource {

    private final Logger log = LoggerFactory.getLogger(UasKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public UasKafkaResource(KafkaProperties kafkaProperties) {
