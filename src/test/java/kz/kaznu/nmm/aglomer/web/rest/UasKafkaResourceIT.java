...
class UasKafkaResourceIT {
    ...
    void setup() {
        ...
        UasKafkaResource kafkaResource = new UasKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/uas-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/uas-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
